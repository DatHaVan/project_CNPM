...
const [quoctichbabyValue, setquoctichbabyValue] = useState('');
  ...
  const onPressGuiDon = async () => {
    try {
      // Hiển thị thông báo thành công
      Alert.alert('GoodBoy đã gửi đơn thành công.');
    ...
    <View style={styles.textDiennamsinhMe}>
     ...
     <View style={styles.textDienquoctichMe}>
      ...
      <TouchableOpacity
          ...
          <Text style={styles.textBackLogin}>Đóng</Text>
     </TouchableOpacity>
    
          <TouchableOpacity
            style={styles.buttonGuiDon}
            onPress={onPressGuiDon} >                     
            <Text style={styles.textStyleDangNhap}>Tui tên Đạt</Text>
          </TouchableOpacity>
